...
import { createPersonalSlot } from '@/lib/actions/personal-slots'
import { Loader2, Plus, Trash2, Check } from 'lucide-react'
import { PRESET_COLORS, WEEKDAYS } from '@/types/database'
...
export function PersonalSlotForm({ open, onClose }: PersonalSlotFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const res = await createPersonalSlot({
      title: title.trim(),
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-xl shadow-lg border border-gray-200 p-6 w-full max-w-lg mx-4 max-h-[90vh] overflow-y-auto">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Add Personal Slot</h3>
